...
public class ListResult {
    ...
    public ListResult(String reportNum, String testItem, String importantGrade, String requirements,
            List<String> nonstandardItems) {
        this.reportNum = reportNum;
    ...
    public String toString() {
        return "{reportNum:'" + this.reportNum + "', testItem:" + this.testItem + "', importantGrade:"
                + this.importantGrade + "', requirements:" + this.requirements + "', nonstandardItems:"
                + this.nonstandardItems + "}";
    }
